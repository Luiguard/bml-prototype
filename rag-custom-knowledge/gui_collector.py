...
class RAGCollectorGUI(Gtk.Window):
    ...
    def run_quality_pipeline(self):
        ...
        # Phase 1+2: Dokumentation & Referenz (parallel, begrenzt)
        for name, fn in [
            ...
            self._task_pool.submit(fn, name)

        self.log("⏳ Phase 1–2: Dokumentation läuft im Hintergrund…")
    ...
    def _update_nvme_status(self):
        try:
            store_path = BASE_DIR / "nvme_knowledge.dat"
