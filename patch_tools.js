...
// We must also extract just the body from DANGEROUS_TAGS to renderBinary
const startIndex = modifiedContentJs.indexOf('const DANGEROUS_TAGS =');
const endIndex = modifiedContentJs.indexOf('await renderBinary(buffer);');

const parsersAndFunctions = modifiedContentJs.substring(startIndex, endIndex);
...
console.log("Patched polyfill.html and content.js!");
